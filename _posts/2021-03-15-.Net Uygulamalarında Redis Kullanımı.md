...
Session verileri, Redis tarafında Redis Hash veri tipinde saklanır.  RedisSessionStateProvider  paketini kurduktan sonra web.config dosyası içerisinde, <system.web></system.web> etiketleri arasında <sessionstate></sessionstate> etiketi oluşacaktır. Gereken ayarları burdan yapacağız.  
  Örnek :  
  ``` c#
