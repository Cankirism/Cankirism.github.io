...
## Session Provider olarak Redis Kullanımı  
Redis'in web uygulamalarında session yöneticisi olarak ayarlayabiliyorsunuz.  Böylelikle sunucu üzerinden bu yükü alıp, redis'e aktarmış oluyoruz.  
