...
- [.Net Redis İmplementasyonu](#.Net-Core-Uygulamasında-Redis-İmplementasyonu)
   - [Entegrasyon](#.Net-Core-Uygulamasında-Redis-İmplementasyonu)
   - [Senaryo](#senaryo)  
   - [Uygulama](#uygulama)  
...
## .Net Core Uygulamasında Redis İmplementasyonu   
.Net Uygulalamızda Redis client işlemleri için Nuget PM üzerinden ServiceStack.Redis kütüphanesini kullanıyor olacağız. 
...
````  
RedisEndpoint Sınıfı, ServiceStack.Redis kütüphanesinden implement edilen, redis işlemlerini yapacağımız sınıftır.   
...
- Tekrar Redis Servisinde Kullanıcı Listesini isteyeceğiz.  
...
```
## Performans  
İlgili düzenlemeden sonra sorgu süresi 6sn'den 150 ms seviyesine inmiştir. Redis Servisi cache hizmetinden beklediğimiz üzerinde performans sergilemiştir.  
